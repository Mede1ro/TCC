...
// Criação do mapa e definição de visão
...
// Conflitos em Buzios
var bz1 = L.marker([-22.74884753005497, -41.95635818360315], { icon: greenIcon }).addTo(map);
...
var bz2 = L.marker([-22.769395296464456, -41.91134553553569], { icon: greenIcon }).addTo(map);
...
var sp1 = L.marker([-22.860275823471152, -42.10987835106725], {icon: greenIcon}).addTo(map);
...
var ac1 = L.marker([-22.97054597934171, -42.031247214308], {icon: greenIcon}).addTo(map);
...
var ar1 = L.marker([-22.877920210547412, -42.32451740467678], {icon: greenIcon}).addTo(map);
...
var ar2 = L.marker([-22.88280298731239, -42.1604148444337], {icon: greenIcon}).addTo(map);
