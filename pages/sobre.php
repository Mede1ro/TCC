...
<body>
  ...
  <main class="container-sobre">
    <div class="conteudo-sobre">
      <div class="conteudo-sobre-bg">
        <img src="../assets/bgsobre.png" alt="">
        <h1>Sobre</h1>
      </div>
      <div class="conteudo-sobre-texto">
        <h1><img class="leaf" src="../assets/leaf.svg" alt=""><span style="color: #4baf47;">Sobre o Projeto:</span> Conflitos Ambientais na Região dos Lagos</h1>
        <p>Bem-vindo ao nosso espaço dedicado à análise e compreensão dos conflitos ambientais na região dos lagos, uma iniciativa desenvolvida como parte do Trabalho de Conclusão de Curso no Instituto Federal do Rio de Janeiro, Campus Campos Arraial do Cabo.</p>
        <br>
        ...
        <br>
        <h2>Compromisso com a Conscientização:</h2>
        <p>Acreditamos que a conscientização é o primeiro passo para a mudança. Ao apresentar informações de maneira acessível e envolvente, esperamos inspirar ações positivas e incentivar a comunidade a participar ativamente na preservação e recuperação do ambiente.</p>
        <br>
        <h2>Participe:</h2>
